...
import io.github.mzdluo123.timetablebot.gen.information_schema.tables.records.SchemaPrivilegesRecord;
...
public class SchemaPrivileges extends TableImpl<SchemaPrivilegesRecord> {
    ...
    private static final long serialVersionUID = 1253427020;
     ...
     */
    public final TableField<SchemaPrivilegesRecord, String> GRANTEE = createField(DSL.name("GRANTEE"), org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false).defaultValue(org.jooq.impl.DSL.inline("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
