...
import io.github.mzdluo123.timetablebot.gen.information_schema.tables.records.SchemataRecord;
...
public class Schemata extends TableImpl<SchemataRecord> {
    ...
    private static final long serialVersionUID = 1176551264;
     ...
     */
    public final TableField<SchemataRecord, String> SQL_PATH = createField(DSL.name("SQL_PATH"), org.jooq.impl.SQLDataType.VARCHAR(512).defaultValue(org.jooq.impl.DSL.inline("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
