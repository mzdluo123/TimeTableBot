...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record8<Integer, Long, String, Long, LocalDateTime, LocalDateTime, Byte, Long> {

    private static final long serialVersionUID = 1669302656;
    ...
    @Override
    public Row8<Integer, Long, String, Long, LocalDateTime, LocalDateTime, Byte, Long> valuesRow() {
    ...
    @Override
    public UserRecord values(Integer value1, Long value2, String value3, Long value4, LocalDateTime value5, LocalDateTime value6, Byte value7, Long value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(Integer id, Long account, String name, Long studentId, LocalDateTime lastActive, LocalDateTime joinTime, Byte enable, Long bot) {
        super(User.USER);
