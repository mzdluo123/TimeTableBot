...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record7<Integer, Long, String, Integer, LocalDateTime, LocalDateTime, Byte> {

    private static final long serialVersionUID = -1675999660;
    ...
    @Override
    public Row7<Integer, Long, String, Integer, LocalDateTime, LocalDateTime, Byte> valuesRow() {
    ...
    @Override
    public UserRecord values(Integer value1, Long value2, String value3, Integer value4, LocalDateTime value5, LocalDateTime value6, Byte value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(Integer id, Long account, String name, Integer studentId, LocalDateTime lastActive, LocalDateTime joinTime, Byte enable) {
        super(User.USER);
