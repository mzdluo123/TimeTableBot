...
import io.github.mzdluo123.timetablebot.gen.information_schema.tables.records.TablePrivilegesRecord;
...
public class TablePrivileges extends TableImpl<TablePrivilegesRecord> {
    ...
    private static final long serialVersionUID = 907529577;
     ...
     */
    public final TableField<TablePrivilegesRecord, String> GRANTEE = createField(DSL.name("GRANTEE"), org.jooq.impl.SQLDataType.VARCHAR(190).nullable(false).defaultValue(org.jooq.impl.DSL.inline("''", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
